...
try:
    from daily_stock_analysis.data_provider.base import is_bse_code, normalize_stock_code
...
try:
    from daily_stock_analysis.data_provider.akshare_fetcher import _to_sina_tx_symbol
