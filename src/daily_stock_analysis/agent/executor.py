...
from daily_stock_analysis.agent.chat_context import build_agent_chat_context_bundle
from daily_stock_analysis.agent.llm_adapter import LLMToolAdapter
from daily_stock_analysis.agent.provider_trace import extract_provider_trace_turns
from daily_stock_analysis.agent.runner import run_agent_loop, parse_dashboard_json
...
class AgentExecutor:
    ...
    def chat(self, message: str, session_id: str, progress_callback: Optional[Callable] = None, context: Optional[Dict[str, Any]] = None) -> AgentResult:
        ...
        """
        from daily_stock_analysis.agent.conversation import conversation_manager
