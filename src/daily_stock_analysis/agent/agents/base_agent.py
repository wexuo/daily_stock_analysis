...
from daily_stock_analysis.agent.protocols import AgentContext, AgentOpinion, StageResult, StageStatus
from daily_stock_analysis.agent.runner import RunLoopResult, run_agent_loop
from daily_stock_analysis.agent.skills.defaults import extract_skill_id
...
class BaseAgent(ABC):
    ...
    def _filtered_registry(self) -> ToolRegistry:
        ...
        from daily_stock_analysis.agent.tools.registry import ToolRegistry as TR
        filtered = TR()
