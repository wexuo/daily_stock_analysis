...
from daily_stock_analysis.agent.skills.defaults import CORE_TRADING_SKILL_POLICY_ZH
...
from daily_stock_analysis.storage import persist_llm_usage
from daily_stock_analysis.data.stock_mapping import STOCK_NAME_MAP
...
from daily_stock_analysis.market_context import get_market_role, get_market_guidelines
from daily_stock_analysis.services.daily_market_context import format_daily_market_context_prompt_section
...
"""
    ...
    def _get_skill_prompt_sections(self) -> tuple[str, str, bool]:
        ...
        if resolved_state is None:
            from daily_stock_analysis.agent.factory import resolve_skill_prompt_state
