...
from daily_stock_analysis.bot.models import WebhookResponse
from daily_stock_analysis.bot.dispatcher import get_dispatcher
from daily_stock_analysis.bot.platforms import ALL_PLATFORMS

if TYPE_CHECKING:
    from daily_stock_analysis.bot.platforms.base import BotPlatform  # noqa: F401
