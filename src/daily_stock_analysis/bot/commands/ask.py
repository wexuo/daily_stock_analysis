...
from daily_stock_analysis.bot.models import BotMessage, BotResponse
...
class AskCommand(BotCommand):
    ...
    def _load_skills() -> List[object]:
        try:
            from daily_stock_analysis.agent.factory import get_skill_manager
    ...
    def _get_default_skill_id(cls) -> str:
        try:
            from daily_stock_analysis.agent.skills.defaults import get_primary_default_skill_id
    ...
    def _build_portfolio_section(
        ...
        def _render_overlay() -> str:
            ...
            from daily_stock_analysis.agent.factory import get_tool_registry
            from daily_stock_analysis.agent.llm_adapter import LLMToolAdapter
            from daily_stock_analysis.agent.protocols import AgentContext
