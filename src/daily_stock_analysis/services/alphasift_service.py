...
from daily_stock_analysis.config import Config, DEFAULT_ALPHASIFT_INSTALL_SPEC, get_configured_llm_models
...
def _get_dsa_search_service() -> Any:
    from daily_stock_analysis.search_service import get_search_service
