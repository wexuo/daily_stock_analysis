...
from daily_stock_analysis.core.trading_calendar import build_market_phase_context, get_market_for_stock
...
from daily_stock_analysis.services.market_light_service import normalize_market_region
...
class AlertWorker:
    ...
    def _send_notification(self, runtime_rule: RuntimeAlertRule, result: Dict[str, Any]) -> "NotificationDispatchResult":
        from daily_stock_analysis.notification import NotificationBuilder, NotificationService
    ...
    def _synthetic_attempt_for_dispatch(dispatch: "NotificationDispatchResult") -> "ChannelAttemptResult":
        from daily_stock_analysis.notification import ChannelAttemptResult
