...
from daily_stock_analysis.core.trading_calendar import get_open_markets_today
...
from daily_stock_analysis.services.portfolio_alerts import RuntimeAlertPayload
