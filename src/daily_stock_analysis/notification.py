...
from daily_stock_analysis.market_phase_summary import format_public_market_status_line, format_public_phase_pack_excerpt
from daily_stock_analysis.notification_routing import (
    get_notification_route_config,
    split_notification_route_channels,
)
from daily_stock_analysis.notification_contracts import is_feishu_static_configured
...
from daily_stock_analysis.utils.sanitize import sanitize_diagnostic_text
from daily_stock_analysis.utils.data_processing import normalize_model_used
...
class NotificationService(
    ...
    def _get_history_compare_context(self, results: List[AnalysisResult]) -> Dict[str, Any]:
        ...
        try:
            from daily_stock_analysis.services.history_comparison_service import get_signal_changes_batch
    ...
    def _send_feishu_stream_reply(self, chat_id: str, content: str) -> bool:
        ...
        """
        try:
            from daily_stock_analysis.bot.platforms.feishu_stream import FeishuReplyClient, FEISHU_SDK_AVAILABLE
    ...
    def generate_dashboard_report(
        ...
        if getattr(config, 'report_renderer_enabled', False) and results:
            from daily_stock_analysis.services.report_renderer import render
            out = render(
                platform='markdown',
                results=results,
