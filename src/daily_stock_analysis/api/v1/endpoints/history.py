...
from daily_stock_analysis.services.history_service import HistoryService, MarkdownReportGenerationError
...
from daily_stock_analysis.market_phase_summary import extract_market_phase_summary
...
def get_stock_bar(
    ...
    try:
        ...
        from daily_stock_analysis.utils.data_processing import parse_json_field
