    ...
    >
      ...
      >
        ...
        {isRailVariant ? (
          ...
          collapsed ? null : (
            <span className="truncate text-[1.02rem] font-medium">
              {t("theme.theme")}
            </span>
          )
        ) : (
      ...
      {open ? (
        <div
          ...
          className={cn(
            "z-[500] min-w-[8rem] overflow-hidden rounded-2xl border border-border/70 bg-elevated p-1.5 shadow-[0_24px_48px_rgba(3,8,20,0.32)] backdrop-blur-xl",
